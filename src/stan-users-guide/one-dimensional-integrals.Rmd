...
Definite and indefinite one dimensional integrals can be performed in Stan using the `integrate\_1d` function.
...
in the Boost library [@BoostQuadrature:2017]. If the nth estimate of the
...
last argument to `integrate_1d` and defaults to the square root of the
machine epsilon of double precision floating point numbers (that is a relative
tolerance of around `1.5e-8`).
