...
If $\mu \in \mathbb{R}$ and $\sigma \in \mathbb{R}^+$, then for $y \in
\mathbb{R}$, \begin{equation*} \text{Cauchy}(y|\mu,\sigma) = \frac{1}{\pi \sigma} \
\frac{1}{1 + \left((y - \mu)/\sigma\right)^2} . \end{equation*}
...
\mathbb{R}$, \begin{equation*} \text{Gumbel}(y|\mu,\beta) = \frac{1}{\beta} \
