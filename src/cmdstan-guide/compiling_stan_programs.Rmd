...
## C++ compilation and linking optimizations flags
...
Stan developers recommend a set of optimization flags that can be turned on by setting `STAN_CPP_OPTIMS=true`
