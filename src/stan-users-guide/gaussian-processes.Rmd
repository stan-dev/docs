...
In this section, we'll consider the function below, for no other reason than it has a nice non-linear shape that we can approximate nicely with Gaussian Process regression using a squared exponential kernel, 'gp_exp_quad_cov'. We won't specify the noise immediately, since we'll consider a few different situations.
