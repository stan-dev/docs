---
pagetitle: Unbounded Continuous Distributions
---
...
\index{{\tt \bfseries normal\_cdf }!{\tt (reals y  \textbar\ reals mu, reals sigma): real}|hyperpage}
...
with normal distribution and identity link function, i.e. a function
...
in terms of a normal distribution and matrix multiplication.
...
`real` **`normal_id_glm_lpdf`**`(real y | row_vector x, real alpha, vector beta, real sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma`.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lupdf`**`(real y | row_vector x, real alpha, vector beta, real sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma` dropping constant additive terms.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lpdf`**`(real y | row_vector x, vector alpha, vector beta, real sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma`.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lupdf`**`(real y | row_vector x, vector alpha, vector beta, real sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma` dropping constant additive terms.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lpdf`**`(real y | row_vector x, real alpha, vector beta, vector sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma`.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lupdf`**`(real y | row_vector x, real alpha, vector beta, vector sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma` dropping constant additive terms.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lpdf`**`(real y | row_vector x, vector alpha, vector beta, vector sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma`.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lupdf`**`(real y | row_vector x, vector alpha, vector beta, vector sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma` dropping constant additive terms.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lpdf`**`(real y | vector x, real alpha, vector beta, real sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma`.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lupdf`**`(real y | vector x, real alpha, vector beta, real sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma` dropping constant additive terms.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lpdf`**`(real y | vector x, vector alpha, vector beta, real sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma`.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lupdf`**`(real y | vector x, vector alpha, vector beta, real sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma` dropping constant additive terms.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lpdf`**`(real y | vector x, real alpha, vector beta, vector sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma`.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lupdf`**`(real y | vector x, real alpha, vector beta, vector sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma` dropping constant additive terms.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lpdf`**`(real y | vector x, vector alpha, vector beta, vector sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma`.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lupdf`**`(real y | vector x, vector alpha, vector beta, vector sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma` dropping constant additive terms.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lpdf`**`(vector y | vector x, real alpha, vector beta, real sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma`.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lupdf`**`(vector y | vector x, real alpha, vector beta, real sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma` dropping constant additive terms.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lpdf`**`(vector y | vector x, vector alpha, vector beta, real sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma`.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lupdf`**`(vector y | vector x, vector alpha, vector beta, real sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma` dropping constant additive terms.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lpdf`**`(vector y | vector x, real alpha, vector beta, vector sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma`.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lupdf`**`(vector y | vector x, real alpha, vector beta, vector sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma` dropping constant additive terms.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lpdf`**`(vector y | vector x, vector alpha, vector beta, vector sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma`.
{{< since 2.40 >}}
...
`real` **`normal_id_glm_lupdf`**`(vector y | vector x, vector alpha, vector beta, vector sigma)`<br>\newline
The log normal probability density of `y` given location `alpha + x * beta`
and scale `sigma` dropping constant additive terms.
{{< since 2.40 >}}
...
\index{{\tt \bfseries exp\_mod\_normal\_lpdf }!{\tt (reals y \textbar\ reals mu, reals sigma, reals lambda): real}|hyperpage}
...
\index{{\tt \bfseries skew\_normal\_cdf }!{\tt (reals y \textbar\ reals xi, reals omega, reals alpha): real}|hyperpage}
...
\index{{\tt \bfseries student\_t\_cdf }!{\tt (reals y \textbar\ reals nu, reals mu, reals sigma): real}|hyperpage}
...
\index{{\tt \bfseries cauchy\_cdf }!{\tt (reals y \textbar\ reals mu, reals sigma): real}|hyperpage}
...
\index{{\tt \bfseries double\_exponential\_cdf }!{\tt (reals y \textbar\ reals mu, reals sigma): real}|hyperpage}
...
\index{{\tt \bfseries logistic\_cdf }!{\tt (reals y \textbar\ reals mu, reals sigma): real}|hyperpage}
...
\index{{\tt \bfseries gumbel\_cdf }!{\tt (reals y \textbar\ reals mu, reals beta): real}|hyperpage}
...
\index{{\tt \bfseries skew\_double\_exponential\_cdf }!{\tt (reals y \textbar\ reals mu, reals sigma, reals tau): real}|hyperpage}
