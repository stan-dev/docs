...
[MCMC Sampling](../reference-manual/mcmc.Rmd).
...
[Automatic Parameter Tuning](../reference-manual/mcmc.Rmd#hmc-algorithm-parameters).
...
[model conditioning and curvature](../stan-users-guide/efficiency-tuning.Rmd#model-conditioning-and-curvature)
provides a discussion of adaptation and stepsize issues.
The Stan Reference Manual section on
[HMC algorithm parameters](../reference-manual/mcmc.Rmd#hmc-algorithm-parameters)
...
[reparameterization](../stan-users-guide/reparameterization.Rmd)
...
[typical set](../stan-users-guide/efficiency-tuning.Rmd#model-conditioning-and-curvature).
