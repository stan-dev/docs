...
The sampler parameters are described in detail in the [output file](mcmc_config.qmd#mcmc_output_csv) section of the Quickstart Guide chapter on MCMC Sampling.
