...
<!-- array[] vector; dae; (function residual, vector initial_state, vector initial_state_derivative, real initial_time, array[] real times, ...); -->
\index{{\tt \bfseries dae }!{\tt (function residual, vector initial\_state, vector initial\_state\_derivative, real initial\_time, array[] real times, ...): array[] vector}|hyperpage}

`array[] vector` **`dae`**`(function residual, vector initial_state, vector initial_state_derivative, real initial_time, array[] real times, ...)`<br>\newline
Solves the DAE system using the backward differentiation formula (BDF)
method [@serban_user:2021].
`r since("2.29")`

<!-- array[] vector; dae_tol; (function residual, vector initial_state, vector initial_state_derivative, real initial_time, array[] real times, data real rel_tol, data real abs_tol, int max_num_steps, ...); -->
\index{{\tt \bfseries dae\_tol }!{\tt (function residual, vector initial\_state, vector initial\_state\_derivative, real initial\_time, array[] real times, data real rel\_tol, data real abs\_tol, int max\_num\_steps, ...): array[] vector}|hyperpage}

`array[] vector` **`dae_tol`**`(function residual, vector initial_state, vector initial_state_derivative, real initial_time, array[] real times, data real rel_tol, data real abs_tol, int max_num_steps, ...)`<br>\newline
