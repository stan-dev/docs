...
The Pathfinder algorithm is described in section [Pathfinder overview](#pathfinder-intro).
...
the CSV sample and the set of ELBO iterations, and therefore no distinguishing suffixes are
