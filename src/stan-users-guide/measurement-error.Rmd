x# Measurement Error and Meta-Analysis
...
\begin{align*}
p(y_n \mid \mu, \sigma)
 &= \int_{y_n - 0.5}^{y_n + 0.5} \mathsf{normal}(z_n \mid \mu, \sigma) \,\mathsf{d}z_n \\
...
is fixed and $\mathsf{normal}(y \mid \mu,\sigma) =
\mathsf{normal}(\mu \mid y,\sigma)$.
