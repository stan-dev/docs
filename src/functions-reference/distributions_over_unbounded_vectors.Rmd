...
If $K \in \mathbb{N}$, $\nu \in \mathbb{R}^+$, $\mu \in \mathbb{R}^K$,
and $L$ a lower-triangular matrix with strictly positive, 
finite diagonal elements that guarantee $LL^{top}$ is a $K \times K$ positive 
...
<!-- real; multi_student_t_cholesky_lpdf; (array[] vector y | real nu, array[] vector mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lpdf }!{\tt (array[] vector y \textbar\ real nu, array[] vector mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lpdf`**`(array[] vector y | real nu, array[] vector mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of vector(s) y given
degrees of freedom nu, location vector(s) mu, and Cholesky factor of the scale matrix L
`r since("2.30")`

<!-- real; multi_student_t_cholesky_lupdf; (array[] vector y | real nu, array[] vector mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lupdf }!{\tt (array[] vectory \textbar\ real nu, array[] vector mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lupdf`**`(array[] vector y | real nu, array[] vector mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of vector(s) y given
degrees of freedom nu, location vector(s) mu, and Cholesky factor of the scale matrix L
dropping constant additive terms
`r since("2.30")`

<!-- real; multi_student_t_cholesky_lpdf; (array[] vector y | real nu, array[] row_vector mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lpdf }!{\tt (array[] vector y \textbar\ real nu, array[] row\_vectors mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lpdf`**`(array[] vector y | real nu, array[] row_vectors mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of vector(s) y given
degrees of freedom nu, location row vector(s) mu, Cholesky factor of the scale matrix L
`r since("2.30")`

<!-- real; multi_student_t_cholesky_lupdf; (array[] vector y | real nu, array[] row_vectors mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lupdf }!{\tt (array[] vector y \textbar\ real nu, array[] row\_vectors mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lupdf`**`(array[] vector y | real nu, array[] row_vectors mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of vector(s) y given
degrees of freedom nu, location row vector(s) mu, Cholesky factor of the scale matrix L
dropping constant additive terms
`r since("2.30")`

<!-- real; multi_student_t_cholesky_lpdf; (array[] row_vector y | real nu, array[] vector mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lpdf }!{\tt (array[] row\_vector y \textbar\ real nu, array[] vector mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lpdf`**`(array[] row_vectors y | real nu, array[] vector mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of row vector(s) y
given degrees of freedom nu, location vector(s) mu, Cholesky factor of the scale matrix L
`r since("2.30")`

<!-- real; multi_student_t_cholesky_lupdf; (array[] row_vector y | real nu, array[] vector mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lupdf }!{\tt (array[] row\_vector y \textbar\ real nu, array[] vector mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lupdf`**`(array[] row_vector y | real nu, array[] vector mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of row vector(s) y
given degrees of freedom nu, location vector(s) mu, Cholesky factor of the scale matrix L
dropping constant additive terms
`r since("2.30")`

<!-- real; multi_student_t_cholesky_lpdf; (array[] row_vector y | real nu, array[] row_vector mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lpdf }!{\tt (array[] row\_vectors y \textbar\ real nu, array[] row\_vector mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lpdf`**`(array[] row_vector y | real nu, array[] row_vector mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of row vector(s) y
given degrees of freedom nu, location row vector(s) mu, and Cholesky factor of the scale matrix L
`r since("2.30")`

<!-- real; multi_student_t_cholesky_lupdf; (array[] row_vector y | real nu, array[] row_vector mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lupdf }!{\tt (array[] row\_vector y \textbar\ real nu, array[] row\_vector mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lupdf`**`(array[] row_vector y | real nu, array[] row_vector mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of row vector(s) y
given degrees of freedom nu, location row vector(s) mu, Cholesky factor of the scale matrix L
dropping constant additive terms
`r since("2.30")`
...
<!-- vector; multi_student_t_cholesky_rng; (real nu, row_vector mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_rng }!{\tt (real nu, row\_vector mu, matrix L): vector}|hyperpage}

`vector` **`multi_student_t_cholesky_rng`**`(real nu, row_vector mu, matrix L)`<br>\newline
Generate a multivariate Student-$t$ variate with degrees of freedom
nu, location mu, and Cholesky factor of the scale matrix L; may only be used in transfomed data
and generated quantities blocks
`r since("2.30")`

<!-- array[] vector; multi_student_t_cholesky_rng; (real nu, array[] vector mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_rng }!{\tt (real nu, array[] vector mu, matrix L): array[] vector}|hyperpage}

`array[] vector` **`multi_student_t_rng`**`(real nu, array[] vector mu, matrix L)`<br>\newline
Generate an array of multivariate Student-$t$ variates with degrees of
freedom nu, locations mu, and Cholesky factor of the scale matrix L; may only be used in
transformed data and generated quantities blocks
`r since("2.30")`

<!-- array[] vector; multi_student_t_cholesky_rng; (real nu, array[] vector mu, matrix Sigma); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_rng }!{\tt (real nu, array[] row\_vector mu, matrix L): array[] vector}|hyperpage}
