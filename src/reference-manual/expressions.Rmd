...
arguments of type `int` may be
promoted to type `real` or `complex` if necessary (see the subsection on type
promotion in [the function application
section](#function-application), a `real` argument may be promoted to
`complex`, a `vector` will be promoted to `complex_vector`, and so on.
