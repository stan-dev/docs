---
pagetitle: Optimization Configuration
---
...
[Optimization chapter](../reference-manual/optimization.Rmd)
...
See the
[BFGS and L-BFGS configuration section](../reference-manual/optimization.Rmd#bfgs-and-l-bfgs-configuration)
