...
- time_total, The combined time spend executing forward and reverse mode
calculations
- forward_time, The time spent executing forward mode calculations. This
includes calculations with and without autodiff.
- reverse_time, The time spent executing reverse mode autodiff for
the `profile` statement
- chain_stack, The number of autodiff objects allocated on the chaining
autodiff stack. There is a function call for each of these objects in
the reverse pass
- no_chain_stack, The number of autodiff obects allocated on the
non-chaining autodiff stack.
- autodiff_calls, The total number of times the `profile` statement was
executed with autodiff
- no_autodiff_calls - The total number of times the `profile` statement
was executed without autodiff
