...
A tuple of one element can be created using the same style as languages like
Python, with a trailing comma, e.g., `(3.14,)`. For longer tuples, Stan does
*not* support trailing commas.
