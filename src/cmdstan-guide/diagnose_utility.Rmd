...
[Stan User's Guide reparameterization section](../stan-users-guide/reparameterization.Rmd).
...
[reparameterization section](../stan-users-guide/reparameterization.Rmd).
...
[Stan Reference Manual](../docs/reference-manual/hmc.Rmd)).
