...
[stochastic gradient ascent](https://mc-stan.org/docs/docs/reference-manual/variational.html#stochastic-gradient-ascent.html).
The measures of convergence are similar to the
relative tolerance scheme of Stan's
[optimization algorithms](https://mc-stan.org/docs/docs/reference-manual/optimization.html).
