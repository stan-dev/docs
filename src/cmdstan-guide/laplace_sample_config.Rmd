...
The `laplace` method produces a samples from a Laplace approximation
...
and how much the true posterior resembles a Gaussian.
...
the value of argument `jacobian` should match its setting for optimization.
