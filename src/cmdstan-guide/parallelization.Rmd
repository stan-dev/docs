...
rewritten to use the [`map_rect` function](../functions-reference/higher-order_functions.Rmd#functions-map). By using MPI, the model can be parallelized across multiple cores or a cluster. MPI with Stan is supported on MacOS and Linux.
