...
Bayesian inference is a statistical power tool.  You embed
...
A big challenge for applied Bayesian inference is
...
Chapter ** of this book includes several case studies to give some
sense of Bayesian modeling on some fairly simple problems, and Chapter
** offers a guide to a large number of Stan case studies that are
...
We gave an example earlier, when we type:
...
Stan also computes for each parameter, transformed parameter, and generated quantity an "effective sample size" which represents . . .
