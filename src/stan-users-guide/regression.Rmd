...
This latter form of the model is coded in Stan as follows [simple_linear_regression](https://github.com/stan-dev/docs/tree/footnote/src/stan-users-guide/simple_linear_regression):


```{r echo=FALSE}
print_file('simple_linear_regression/regression_naive.stan')
```
...
```{r echo=FALSE}
print_file('simple_linear_regression/regression_matrix.stan')
```
...
```{r echo=FALSE}
print_file('simple_linear_regression/regression_QR.stan')
```
...
sampling distribution is changed to the following [student_t_regression]( https://github.com/stan-dev/docs/tree/footnote/src/stan-users-guide/student_t_regression).
