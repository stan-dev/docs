...
- `jacobian` - Whether or not the [Jacobian adjustment for constrained](../stan-users-guide/reparameterization.Rmd)
...
the Stan reference manual [section on variable transforms](../reference-manual/transforms.Rmd).
