...
way to generate the times of failure because they for the times of
failure because the baseline hazard function $h_0(t)$ is unmodeled; if
the baseline hazard were known, failure times could be generated.  The
proportional hazards model is generative for the ordering of failures
conditional on a number of censored items.
