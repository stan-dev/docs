...
```
for (m in 1:M) {
  y_rep[m] <- sample_uniform_w_replacement(y)
...
accurate 97.5% quantile estimates requires a large number of Monte
Carlo simulations.
...
can guard against overcertainty in a poorly specified model.