...
\index{{\tt \bfseries dirichlet\_lpdf }!{\tt (vectors theta | vectors alpha): real}|hyperpage}
...
\index{{\tt \bfseries dirichlet\_lupdf }!{\tt (vectors theta | vectors alpha): real}|hyperpage}
