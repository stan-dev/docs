...
Return the discrete Fourier transform of the specified complex matrix `m`.
`r since("2.30")`

<!-- complex_vector; inv_fft; (complex_vector v); -->
\index{{\tt \bfseries inv\_fft }!{\tt (complex\_vector v): complex\_vector}|hyperpage}

`complex_vector` **`inv_fft`**`(complex_vector v)`<br>\newline
