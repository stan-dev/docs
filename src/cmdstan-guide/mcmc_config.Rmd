...
The saved metric file name is the output file basename with the suffix "_metric.json".
...
As described in the [quickstart section](#multi-chain-sampling) on parallelism,
