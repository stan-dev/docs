...
section](../functions-reference/integer-valued_basic_functions.Rmd#int-arithmetic)
...
[section](../stan-users-guide/regression.Rmd#ordered-logistic.section)).
...
functions](../stan-users-guide/basic-functions.Rmd#type-declarations-for-functions).
