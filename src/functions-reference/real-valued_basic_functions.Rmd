...
When applied to two real values, the result is a real value.  When
applied to two arrays, or combination of a real value and an array,
...
Alternatively, if a combination of an array and a real are
provided, the real value is broadcast to be applied to each
...
and to combinations of these with real values.
For example,
...
\index{{\tt \bfseries binary_log_loss }!{\tt (T1 x, T2 y): R}|hyperpage}
...
<!-- R; owens_t; (T1 x, T2 y); -->
\index{{\tt \bfseries owens_t }!{\tt (T1 x, T2 y): R}|hyperpage}
...
<!-- R; gamma_p; (T1 x, T2 y); -->
\index{{\tt \bfseries gamma_p }!{\tt (T1 x, T2 y): R}|hyperpage}
...
<!-- R; gamma_q; (T1 x, T2 y); -->
\index{{\tt \bfseries gamma_q }!{\tt (T1 x, T2 y): R}|hyperpage}
...
\index{{\tt \bfseries binomial_coefficient_log }!{\tt (T1 x, T2 y): R}|hyperpage}
...
\index{{\tt \bfseries bessel_first_kind }!{\tt (T1 x, T2 y): R}|hyperpage}
...
\index{{\tt \bfseries bessel_second_kind }!{\tt (T1 x, T2 y): R}|hyperpage}
...
\index{{\tt \bfseries modified_bessel_first_kind }!{\tt (T1 x, T2 y): R}|hyperpage}
...
\index{{\tt \bfseries modified_bessel_second_kind }!{\tt (T1 x, T2 y): R}|hyperpage}
...
\index{{\tt \bfseries falling_factorial }!{\tt (T1 x, T2 y): R}|hyperpage}
...
\index{{\tt \bfseries rising_factorial }!{\tt (T1 x, T2 y): R}|hyperpage}
...
\index{{\tt \bfseries log_rising_factorial }!{\tt (T1 x, T2 y): R}|hyperpage}
...
\index{{\tt \bfseries multiply_log }!{\tt (T1 x, T2 y): R}|hyperpage}
...
\index{{\tt \bfseries log_diff_exp }!{\tt (T1 x, T2 y): R}|hyperpage}
