...
and it reduces the stepsize when the test fails.
From the above test one can see the role of tolerances by assuming different scales of
$y$. On one hand, the absolute tolerance has little effect when $y_i \gg 1$, on the other the relative tolerance can
