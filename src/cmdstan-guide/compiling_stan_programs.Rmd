...
When calling `make`, the target is name of the CmdStan executable
...
If the `make` target to build the `bernoulli` CmdStan executable
is invoked a second time, it will see that it is up to date,
