...
The executable does not need to be recompiled in order to
switch to Pathfinder, and the data input format is the
same. The following is a minimal call to Stan's variational inference
...
Here it indicates the default mean-field setting of the variational
...
_Pathfinder: Parallel quasi-Newton variational inference._
arxiv 2108.03782. https://doi.org/10.48550/arXiv.2108.03782
