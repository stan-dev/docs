...
Stan offers two algebraic solvers.
The first one, `algebra_solver`, uses the Powell hybritd method [@Powell:1970],
...
The second solver, `algebra_solver_newton`, uses Newton's method,
...
In general, this method works better than Powell's algorithm,
though the user should be prepared to try both solvers.
