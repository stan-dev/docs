...
2. The use of any [deprecated
   features](../reference-manual/deprecations.Rmd)
...
2. Syntactic errors occur whenever a program violates the Stan language's
   [syntax](../reference-manual/syntax.Rmd) requirements.
...
3. Semantic errors (also known as type errors) occur when a program is structured
   ...
   rules](../reference-manual/syntax.Rmd#extra-grammatical-constraints)
...
4. The compiler will raise an error for use of any [removed
   features](../reference-manual/removals.Rmd)
...
Reference](../functions-reference/overview.qmd), a warning
...
[the LKJ correlation distribution section](../functions-reference/correlation_matrix_distributions.Rmd#lkj-correlation)
...
[the efficiency tuning section](../stan-users-guide/efficiency-tuning.Rmd#standardizing-predictors-and-outputs)
...
[deprecation features](../reference-manual/deprecations.Rmd)
