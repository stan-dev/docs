...
We set the prior for the noise more diffuse, and then the noise for the Gaussian Process is estimated from the data. Beware, however, since the hyper prior is more diffuse and the true noise is likely less diffuse, this sub-model has potential to funnel and sample slowly.
