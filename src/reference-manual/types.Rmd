...
Arrays can also be declared using the old array syntax. Equivalent
declarations of `x` and `m` are.
```stan
real x[10];
matrix[3, 3] m[6, 7];
```

Using the new array syntax with the `array` keyword is advised.
...
enclosed in square brackets and the array type and the name of the variable.
...
Arrays can also be declared by enclosing the dimensions in square brackets
following the name of the variable.

The old array sytnax for the above examples is as follows.
