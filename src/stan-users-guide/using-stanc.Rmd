...
- `-Oexperimental` **WARNING:** _This is currently an experimental feature whose components are not thoroughly tested and may not improve a programs performance!_ Allow the compiler to apply all optimizations to the Stan code.

- `--O` **WARNING:** _This is currently an experimental feature whose components are not thoroughly tested and may not improve a programs performance!_ Allow the compiler to apply all optimizations to the Stan code.
