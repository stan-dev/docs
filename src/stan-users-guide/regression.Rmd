...
This latter form of the model is coded in Stan as follows [linear_regression_1](https://github.com/stan-dev/docs/tree/footnote/src/stan-users-guide/linear_regression_1)


```{r echo=FALSE}
library(knitr)
library(readr)
stan_file = read_file('linear_regression_1/regression_1.stan')
