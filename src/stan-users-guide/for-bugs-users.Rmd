...
product, $\mathsf{normal}(y \mid 0,1) * \mathsf{normal}(y \mid 2,3)$, into the
density function.
...
density.  Multiplying them gives, $\mathsf{normal}(x \mid 0.8y,\sigma)
\times \mathsf{normal}(y \mid 0.8x,\sigma)$, which is what it is (you can
