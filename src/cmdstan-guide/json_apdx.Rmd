...
and not-a-number can be represented in multiple ways.  Positive infinity can 
represented as the string `"Inf"`, the string `"Infinity"`, or the atom `Infinity`.
Negative infinity can represented as the string `"-Inf"`, the string `"-Infinity"`, 
or the atom `-Infinity`. Not-a-number can be represented as as the string `"NaN"`
