...
Using only the draws $\{\theta^{(i)}\}_{i = 1}^M$, how can we estimate $\mathbb{E}[g(\Theta, Z)]$? We can use a conditional estimator. That is, for each function $g$ of interest we can compute
$$    
