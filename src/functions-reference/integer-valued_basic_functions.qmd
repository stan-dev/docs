---
pagetitle: Integer-Valued Basic Functions
---
...
types of arguments and return integer values.
...
value is `data`. See
[data only qualifiers](https://mc-stan.org/docs/reference-manual/user-functions.html#data-only-qualifiers)
