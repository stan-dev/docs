...
The scaling of the computational cost with ODE states and parameters
of the adjoint sensitivity approach is far better than the forward
...
parameters $M$, the adjoint sensitivity approach scales linear in
states $N$ and parameters $M$. However, the adjoint problem is harder
