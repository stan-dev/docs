...
This latter form of the model is coded in Stan as follows [linear_regression_1](regression_1/)

#(https://github.com/stan-dev/docs/tree/master/src/stan-users-guide/regression_1/):

```{r echo=FALSE}
library(knitr)
library(readr)
stan_file = read_file('regression_1/regression_1.stan')
...
one predictor can be written directly using matrix notation [linear_regression_2](linear_regression_2).
