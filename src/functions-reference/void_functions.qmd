...
Stan supports a few special statements for printing or for signalling
...
The fatal_error statement has the same syntax as the print and reject
...
algorithm completely. It can be viewed as an un-recoverable version
