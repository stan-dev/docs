...
Further and more comprehensive visualizations are
available from the downstream analysis packages in the [Stan ecosystem](ecosystem.qmd).
In R these are provided by packages [`posterior`](https://github.com/stan-dev/posterior)
and [`bayesplot`](https://github.com/stan-dev/bayesplot); see vignette
...
The Python package [ArviZ](https://python.arviz.org/) provides similar plots;
see chapter [Prior and Posterior predictive checks](https://arviz-devs.github.io/EABM/Chapters/Prior_posterior_predictive_checks.html).


## Posterior "_p_-values"
...
\, \textrm{d}{y^{\textrm{rep}}}.
$$
It is important to note that "_p_-values" is in quotes because these
