...
[stochastic gradient ascent](../docs/reference-manual/variational.Rmd#stochastic-gradient-ascent.html).
The measures of convergence are similar to the
relative tolerance scheme of Stan's
[optimization algorithms](../docs/reference-manual/optimization.Rmd).
