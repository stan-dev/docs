...
<!-- real; poisson_binomial_lpmf; (ints n | vector theta); -->
\index{{\tt \bfseries poisson\_binomial\_lpmf }!{\tt (ints n | vector theta): real}|hyperpage}

`real` **`poisson_binomial_lpmf`**`(ints n | vector theta)`<br>\newline
...
\index{{\tt \bfseries poisson\_binomial\_lupmf }!{\tt (ints n | vector theta): real}|hyperpage}

`real` **`poisson_binomial_lupmf`**`(ints n | vector theta)`<br>\newline
The log Poisson-binomial probability mass of `n` given success probabilities `theta` dropping constant
additive terms

<!-- real; poisson_binomial_cdf; (ints n, vector theta); -->
\index{{\tt \bfseries poisson\_binomial\_cdf }!{\tt (ints n, vector theta): real}|hyperpage}

`real` **`poisson_binomial_cdf`**`(ints n, vector theta)`<br>\newline
The Poisson-binomial cumulative distribution function of `n` given success probabilities `theta` 

<!-- real; poisson_binomial_lcdf; (ints n | vector theta); -->
\index{{\tt \bfseries poisson\_binomial\_lcdf }!{\tt (ints n \textbar\ vector theta): real}|hyperpage}

`real` **`poisson_binomial_lcdf`**`(ints n | vector theta)`<br>\newline
The log of the Poisson-binomial cumulative distribution function of `n` given
success probabilities `theta`

<!-- real; poisson_binomial_lccdf; (ints n | vector theta); -->
\index{{\tt \bfseries poisson\_binomial\_lccdf }!{\tt (ints n \textbar\ vector theta): real}|hyperpage}

`real` **`poisson_binomial_lccdf`**`(ints n | vector theta)`<br>\newline
...
The log Poisson-binomial probability mass of an array of observations `n` given an array of success probabilities `theta`
...
The Poisson-binomial cumulative distribution function of an array of observations `n` given an array of success probabilities `theta`
...
The log of the Poisson-binomial cumulative distribution function of an array of observations `n` given an array of success probabilities `theta`
...
The log of the Poisson-binomial complementary cumulative distribution function of an array of observations `n` given an array of success probabilities `theta`

<!-- R; poisson_binomial_rng; (vector theta); -->
\index{{\tt \bfseries poisson\_binomial\_rng }!{\tt (vector theta): R}|hyperpage}

`R` **`poisson_binomial_rng`**`(vector theta)`<br>\newline
