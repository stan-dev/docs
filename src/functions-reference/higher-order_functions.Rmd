...
we  call such arguments the _variadic arguments_ and denote them as `...`.
...
If the norm is below the function tolerance, the solution s deemed acceptable.
Default value is $10^{-6}$.

*   *`max_num_steps`*: maximum number of steps to take in the
algebraic solver, type `int`, data only. Default value is $200$.
