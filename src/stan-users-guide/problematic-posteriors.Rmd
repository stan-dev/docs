...
Since the probability of $y$ depends only on the difference between ability
and difficulty, it is unchanged by adding any constant $c$ to all the abilities
and difficulties, i.e.,
