...
With the affine transform, the sampling happens in different parameter space.
The model itself doesn’t change if we make parameter transformation,
but the geometry of the transformed space can be easier for the sampler.
The above model is equivalent to the hand-coded non-centered parameterization.
