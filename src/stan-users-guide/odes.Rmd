...
need to be solved with high precision or if the solution goes very near zero,
...
`ckrk`. Knowing nothing about the ODE, start with the `rk45` solver. The
list below has information on when each solver is useful.
