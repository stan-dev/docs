...
[multiple indexing
rules](https://mc-stan.org/docs/reference-manual/language-multi-indexing.html).

To avoid confusion nested multiple indexing in assignment became an error in Stan 2.32.
