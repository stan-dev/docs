...
Perhaps most importantly, the parameters $l$ and $\tau$ are weakly
...
GPs  can represent a wide spectrum of functions.  For length scales below the minimum spacing
of the covariates, the GP likelihood plateaus.  Unless regularized by a prior, this flat
