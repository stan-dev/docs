...
shape as the argument.  There are many functions that are vectorized
in addition to the ad hoc cases listed in this section; see section
[function vectorization](#fun-vectorization) for the general cases.
