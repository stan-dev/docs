...
For convience of using values stored in tuples, Stan supports
...
[assignable expressions](#right-hand-side-expressions) and must match in size the
tuple on the right. Additionally, the same variable may not appear more
