...
- `--canonicalize=<option1,...,optionN>` - Make changes to the program before
  pretty-printing by specifying options in a comma separated list. Options are
  'deprecations', 'parentheses', 'braces'.
