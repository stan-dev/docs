...
As described in the [Truncated or Censored Data](./truncation-censoring.qmd) chapter, the cumulative distribution function ($\text{CDF}$) and its complement ($\text{CCDF}$) are needed to model truncated and censored data.
