...
`R` **`inv_Phi`**`(T x)`<br>\newline
Return the standard normal inverse cumulative distribution function of p,
otherwise known as the quantile function. The algorithm is detailed in [@Wichura:1988]
The algorithm provides provides precise results up to about 16 digits for values between (1e-16, 0.999999999).
Values smaller than 1e-16 are untested. Values above 0.999999999 result in increasingly larger errors.
