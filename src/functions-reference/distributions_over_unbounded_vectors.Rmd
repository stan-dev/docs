...
\end{array} \] If $L$ is lower triangular and
$LL^{top}$ is a $K \times K$ positive definite matrix, then $L_{k,k}$
must be strictly positive for $k \in 1{:}K$.  If an $L$ is provided
that is not the Cholesky factor of a positive-definite matrix, the
probability functions will raise errors.
...
<!-- real; multi_student_t_cholesky_lpdf; (vectors y | real nu, row_vectors mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lpdf }!{\tt (vectors y \textbar\ real nu, row\_vectors mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lpdf`**`(vectors y | real nu, row_vectors mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of vector(s) y given
degrees of freedom nu, location row vector(s) mu, Cholesky factor of the scale matrix L
`r since("2.30")`

<!-- real; multi_student_t_cholesky_lupdf; (vectors y | real nu, row_vectors mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lupdf }!{\tt (vectors y \textbar\ real nu, row\_vectors mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lupdf`**`(vectors y | real nu, row_vectors mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of vector(s) y given
degrees of freedom nu, location row vector(s) mu, Cholesky factor of the scale matrix L
dropping constant additive terms
`r since("2.30")`

<!-- real; multi_student_t_cholesky_lpdf; (row_vectors y | real nu, vectors mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lpdf }!{\tt (row\_vectors y \textbar\ real nu, vectors mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lpdf`**`(row_vectors y | real nu, vectors mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of row vector(s) y
given degrees of freedom nu, location vector(s) mu, Cholesky factor of the scale matrix L
`r since("2.30")`

<!-- real; multi_student_t_cholesky_lupdf; (row_vectors y | real nu, vectors mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lupdf }!{\tt (row\_vectors y \textbar\ real nu, vectors mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lupdf`**`(row_vectors y | real nu, vectors mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of row vector(s) y
given degrees of freedom nu, location vector(s) mu, Cholesky factor of the scale matrix L
dropping constant additive terms
`r since("2.30")`

<!-- real; multi_student_t_cholesky_lpdf; (row_vectors y | real nu, row_vectors mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lpdf }!{\tt (row\_vectors y \textbar\ real nu, row\_vectors mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lpdf`**`(row_vectors y | real nu, row_vectors mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of row vector(s) y
given degrees of freedom nu, location row vector(s) mu, and Cholesky factor of the scale matrix L
`r since("2.30")`

<!-- real; multi_student_t_cholesky_lupdf; (row_vectors y | real nu, row_vectors mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_lupdf }!{\tt (row\_vectors y \textbar\ real nu, row\_vectors mu, matrix L): real}|hyperpage}

`real` **`multi_student_t_cholesky_lupdf`**`(row_vectors y | real nu, row_vectors mu, matrix L)`<br>\newline
The log of the multivariate Student-$t$ density of row vector(s) y
...
<!-- vectors; multi_student_t_cholesky_rng; (real nu, vectors mu, matrix L); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_rng }!{\tt (real nu, vectors mu, matrix L): vectors}|hyperpage}

`vectors` **`multi_student_t_rng`**`(real nu, vectors mu, matrix L)`<br>\newline
Generate an array of multivariate Student-$t$ variates with degrees of
...
<!-- vectors; multi_student_t_rng; (real nu, row_vectors mu, matrix Sigma); -->
\index{{\tt \bfseries multi\_student\_t\_cholesky\_rng }!{\tt (real nu, row\_vectors mu, matrix L): vectors}|hyperpage}

`vectors` **`multi_student_t_cholesky_rng`**`(real nu, row_vectors mu, matrix L)`<br>\newline
Generate an array of multivariate Student-$t$ variates with degrees of
freedom nu, locations mu, and Cholesky factor of the scale matrix L; may only be used in
transformed data andgenerated quantities blocks
`r since("2.30")`
