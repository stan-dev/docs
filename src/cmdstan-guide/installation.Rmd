...
- The CmdStan C++ source code and libraries.
    ...
    + [CmdStan releases](https://github.com/stan-dev/cmdstan/releases)  are available from GitHub as a compressed tarfile containing all C++ source code and libraries.  
The most recent CmdStan release is always availabe as https://github.com/stan-dev/cmdstan/releases/latest.
