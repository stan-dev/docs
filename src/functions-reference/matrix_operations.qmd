...
\index{{\tt \bfseries trace\_dot }!{\tt (matrix A, matrix B): real}|hyperpage}

`real` **`trace_dot`**`(matrix A, matrix B)`<br>\newline
...
<!-- row_vector; softmax; (row_vector x); -->
\index{{\tt \bfseries softmax }!{\tt (row\_vector x): row\_vector}|hyperpage}

`row_vector` **`softmax`**`(row_vector x)`<br>\newline
The softmax of `x`
{{< since 2.40 >}}

<!-- array[] vector; softmax; (array[] vector x); -->
\index{{\tt \bfseries softmax }!{\tt (array[] vector x): array[] vector}|hyperpage}

`array[] vector` **`softmax`**`(array[] vector x)`<br>\newline
The softmax of each element of `x`
{{< since 2.40 >}}

<!-- array[] row_vector; softmax; (array[] row_vector x); -->
\index{{\tt \bfseries softmax }!{\tt (array[] row\_vector x): array[] row\_vector}|hyperpage}

`array[] row_vector` **`softmax`**`(array[] row_vector x)`<br>\newline
The softmax of each element of `x`
{{< since 2.40 >}}
...
<!-- row_vector; log_softmax; (row_vector x); -->
\index{{\tt \bfseries log\_softmax }!{\tt (row\_vector x): row\_vector}|hyperpage}

`row_vector` **`log_softmax`**`(row_vector x)`<br>\newline
The natural logarithm of the softmax of `x`
{{< since 2.40 >}}

<!-- array[] vector; log_softmax; (array[] vector x); -->
\index{{\tt \bfseries log\_softmax }!{\tt (array[] vector x): array[] vector}|hyperpage}

`array[] vector` **`log_softmax`**`(array[] vector x)`<br>\newline
The natural logarithm of the softmax of each element of `x`
{{< since 2.40 >}}

<!-- array[] row_vector; log_softmax; (array[] row_vector x); -->
\index{{\tt \bfseries log\_softmax }!{\tt (array[] row\_vector x): array[] row\_vector}|hyperpage}

`array[] row_vector` **`log_softmax`**`(array[] row_vector x)`<br>\newline
The natural logarithm of the softmax of each element of `x`
{{< since 2.40 >}}
...
<!-- matrix; gp_matern23_cov; (array[] real x, real sigma, real length_scale); -->
...
<!-- matrix; gp_matern23_cov; (array[] real x1, array[] real x2, real sigma, real length_scale); -->
...
<!-- matrix; gp_matern23_cov; (vectors x, real sigma, real length_scale); -->
...
<!-- matrix; gp_matern23_cov; (vectors x, real sigma, array[] real length_scale); -->
...
<!-- matrix; gp_matern23_cov; (vectors x1, vectors x2, real sigma, real length_scale); -->
...
<!-- matrix; gp_matern23_cov; (vectors x1, vectors x2, real sigma, array[] real length_scale); -->
