...
\mainmatter
```
# <i style="font-size: 110%; padding:1.5em 0 0 0; color:var(--bs-body-color)">Overview</i> {-}

<img style="float:right; margin: -2em 0em 4em 4em" src="https://mc-stan.org/images/stan_logo.png" width="225" alt="Stan logo" />

This is the reference manual for the functions defined in the Stan math
