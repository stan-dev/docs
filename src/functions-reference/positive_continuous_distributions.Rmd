---
pagetitle: Positive Continuous Distributions
---
...
\index{{\tt \bfseries lognormal\_cdf }!{\tt (reals y  \textbar\ reals mu, reals sigma): real}|hyperpage}
...
\index{{\tt \bfseries chi\_square\_cdf }!{\tt (reals y \textbar\ reals nu): real}|hyperpage}
...
\index{{\tt \bfseries inv\_chi\_square\_cdf }!{\tt (reals y \textbar\ reals nu): real}|hyperpage}
...
\index{{\tt \bfseries scaled\_inv\_chi\_square\_cdf }!{\tt (reals y \textbar\ reals nu, reals sigma): real}|hyperpage}
...
\index{{\tt \bfseries exponential\_cdf }!{\tt (reals y \textbar\ reals beta): real}|hyperpage}
...
\index{{\tt \bfseries gamma\_cdf }!{\tt (reals y \textbar\ reals alpha, reals beta): real}|hyperpage}
...
\index{{\tt \bfseries inv\_gamma\_cdf }!{\tt (reals y \textbar\ reals alpha, reals beta): real}|hyperpage}
...
$y \in [0,\infty)$, \begin{equation*} \text{Weibull}(y|\alpha,\sigma) =
...
\index{{\tt \bfseries weibull\_cdf }!{\tt (reals y \textbar\ reals alpha, reals sigma): real}|hyperpage}
...
If $\alpha \in \mathbb{R}^+$ and $\sigma \in \mathbb{R}^+$, then for
$y \in \mathbb{R}^+$, \begin{equation*} \text{Frechet}(y|\alpha,\sigma) =
\frac{\alpha}{\sigma} \, \left( \frac{y}{\sigma} \right)^{-\alpha - 1}
\, \exp \! \left( \! - \left( \frac{y}{\sigma} \right)^{-\alpha}
\right) . \end{equation*}
...
\index{{\tt \bfseries frechet\_cdf }!{\tt (reals y \textbar\ reals alpha, reals sigma): real}|hyperpage}
...
\index{{\tt \bfseries rayleigh\_cdf }!{\tt (real y  \textbar\ real sigma): real}|hyperpage}
...
\index{{\tt \bfseries loglogistic\_cdf }!{\tt (reals y  \textbar\ reals alpha, reals beta): real}|hyperpage}
