...
\frac{\phi}{\mu+\phi} \right)^{\!\phi} \!. \end{equation*}

The mean and variance of a random variable $n \sim
\text{NegBinomial2}(n~|~\mu,\phi)$ are \begin{equation*} \mathbb{E}[n] = \mu \ \ \
\text{ and } \ \ \ \text{Var}[n] = \mu + \frac{\mu^2}{\phi}. \end{equation*} Recall
