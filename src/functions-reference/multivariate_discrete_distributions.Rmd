...
$\sum_{k=1}^K y_k = N$, \begin{equation*} \text{Multinomial}(y|\theta) =
\binom{N}{y_1,\ldots,y_K} \prod_{k=1}^K \theta_k^{y_k}, \end{equation*} where the
multinomial coefficient is defined by \begin{equation*} \binom{N}{y_1,\ldots,y_k} =
\frac{N!}{\prod_{k=1}^K y_k!}. \end{equation*}
...
\text{$K$-simplex}$, then for $y \in \mathbb{N}^K$ such that
$\sum_{k=1}^K y_k = N$, \begin{equation*}
\text{MultinomialLogit}(y \mid \gamma) = \text{Multinomial}(y \mid \text{softmax}(\gamma)) =
\binom{N}{y_1,\ldots,y_K} \prod_{k=1}^K [\text{softmax}(\gamma_k)]^{y_k}, \end{equation*} where the
multinomial coefficient is defined by \begin{equation*} \binom{N}{y_1,\ldots,y_k} =
\frac{N!}{\prod_{k=1}^K y_k!}. \end{equation*}
