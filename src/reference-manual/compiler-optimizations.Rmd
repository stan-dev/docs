...
To print out a representation of the optimized Stan program, use the Stanc3 command-line flag `--debug-optimized-mir-pretty`. To see an analagous representation of the Stan program prior to optimization, use the flag `--debug-transformed-mir-pretty`.
