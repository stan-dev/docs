...
The `algebra_solver` and `algebra_solver_newton` functions may be used without control
parameters; in this case

* the first argument refers to a function with signature
...
The `algebra_solver` and `algebra_solver_newton` functions may accept three additional arguments,
