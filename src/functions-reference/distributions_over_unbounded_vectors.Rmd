...
The notation used in the sampling statements is further defined at [probability vectorization](#prob-vectorization).
`r since("2.30")`
...
<!-- vectors; multi_student_t_cholesky_rng; (real nu, row_vectors mu, matrix L); -->
...
<!-- vectors; multi_student_t_cholesky_rng; (real nu, vectors mu, matrix Sigma); -->
