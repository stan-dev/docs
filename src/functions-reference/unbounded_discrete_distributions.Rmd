...
\index{{\tt \bfseries poisson\_binomial\_lpmf }!{\tt (ints n | vectors theta): real}|hyperpage}
...
<!-- real; poisson_binomial_lupmf; (int n | vectors theta); -->
\index{{\tt \bfseries poisson\_binomial\_lupmf }!{\tt (ints n | vectors theta): real}|hyperpage}
...
\index{{\tt \bfseries poisson\_binomial\_cdf }!{\tt (ints n, vectors theta): real}|hyperpage}
